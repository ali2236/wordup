...
class SharedPreferenceDataSource<M extends Model, ID, F> extends DataSource<M, ID, F> {
  final String prefix;
  final M Function(JSON json) fromJson;
  final SharedPreferences _prefs;

  SharedPreferenceDataSource(this._prefs, {this.prefix = 'default', required this.fromJson});
